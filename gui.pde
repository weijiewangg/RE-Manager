...
public void createGUI(){
  ...
  song = new GDropList(soundWindow, 150, 170, 90, 120, 5, 10);
  song.setItems(loadStrings("list_957168"), 0);
  song.addEventHandler(this, "songClicked");
  volumeSlider = new GCustomSlider(soundWindow, 110, 80, 170, 75, "grey_blue");
