...
public void Shape_Click(GDropList source, GEvent event) { //_CODE_:Shape:453247:
  type = Shape.getSelectedText();
  s1 = new Shape(type, numShapes, xPoint, yPoint, xSpeed, ySpeed);
} //_CODE_:Shape:453247:

public void shapesNum_change1(GCustomSlider source, GEvent event) { //_CODE_:shapesNum:792720:
  numShapes = shapesNum.getValueI();
  s1 = new Shape(type, numShapes, xPoint, yPoint, xSpeed, ySpeed);
} //_CODE_:shapesNum:792720:

public void xPoint_change1(GCustomSlider source, GEvent event) { //_CODE_:xPointSlider:505651:
  xPoint = xPointSlider.getValueF();
  s1 = new Shape(type, numShapes, xPoint, yPoint, xSpeed, ySpeed);
} //_CODE_:xPointSlider:505651:

public void yPoint_change1(GCustomSlider source, GEvent event) { //_CODE_:yPointSlider:537343:
  yPoint = yPointSlider.getValueF();
  s1 = new Shape(type, numShapes, xPoint, yPoint, xSpeed, ySpeed);
} //_CODE_:yPointSlider:537343:

public void xSpeed1_change1(GCustomSlider source, GEvent event) { //_CODE_:xSpeed1:323610:
  xSpeed = xSpeed1.getValueF();
  s1 = new Shape(type, numShapes, xPoint, yPoint, xSpeed, ySpeed);
} //_CODE_:xSpeed1:323610:

public void ySpeed1_change1(GCustomSlider source, GEvent event) { //_CODE_:ySpeed1:688483:
  ySpeed = ySpeed1.getValueF();
  s1 = new Shape(type, numShapes, xPoint, yPoint, xSpeed, ySpeed);
} //_CODE_:ySpeed1:688483:
